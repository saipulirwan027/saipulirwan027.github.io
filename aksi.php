...
require_once'functions.php';
    ...
    if ($mod=='login'){
        ...
        elseif( $pass2 != $pass3 )
            ...
            $db->query("UPDATE tb_user SET pass='$pass', pass2='$pass2', pass3='$pass3' WHERE user='$_SESSION[user]'");                    
    ...
    if($mod=='tempat_tambah'){
        ...
        if($nama_tempat=='' || $gambar['name']=='' ||    $lat=='' || $lng==''  )
            ...
            $db->query("INSERT INTO tb_tempat (nama_tempat, gambar,  profil,  lat, lng) 
                    VALUES ('$nama_tempat', '$file_name',  '$profil','$lat', '$lng' )");                       
        ...
        if($nama_tempat=='' || $lat=='' || $lng==''  )
            ...
            $db->query("UPDATE tb_tempat SET nama_tempat='$nama_tempat' $sql_gambar,  profil='$profil',  lat='$lat', lng='$lng'  WHERE id_tempat='$_GET[ID]'");
            redirect_js("index.php?m=tempat");
        }    
    ...
    if($mod=='galeri_tambah'){
        ...
        if($id_tempat=='' || $gambar[name]=='')
            ...
            $db->query("INSERT INTO tb_galeri (id_tempat, gambar) 
                    VALUES('$id_tempat', '$file_name')");                       
        ...
        if($id_tempat=='')
            ...
            $db->query("UPDATE tb_galeri SET id_tempat='$id_tempat' $sql_gambar WHERE id_galeri='$_GET[ID]'");
            redirect_js("index.php?m=galeri");
        }    
